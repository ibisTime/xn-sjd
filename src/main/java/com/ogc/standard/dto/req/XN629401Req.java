 ...
 * @history:
 */
public class XN629401Req extends BaseReq {
    ...
    // 规格列表
    @NotEmpty
    private List<XN629401ReqSpecs> presellSpecsList;
    ...
    public List<XN629401ReqSpecs> getPresellSpecsList() {
        return presellSpecsList;
    }

    public void setPresellSpecsList(List<XN629401ReqSpecs> presellSpecsList) {
