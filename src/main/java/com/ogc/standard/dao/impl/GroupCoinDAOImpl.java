...
public class GroupCoinDAOImpl extends AMybatisTemplate
        implements IGroupCoinDAO {
    ...
    public GroupCoin select(GroupCoin condition) {
        return super.select(NAMESPACE.concat("select_groupCoin"), condition,
            GroupCoin.class);
    }
    ...
    public long selectTotalCount(GroupCoin condition) {
        return super.selectTotalCount(
            NAMESPACE.concat("select_groupCoin_count"), condition);
    }

    @Override
    public List<GroupCoin> selectList(GroupCoin condition) {
        return super.selectList(NAMESPACE.concat("select_groupCoin"), condition,
            GroupCoin.class);
    }

    @Override
    public List<GroupCoin> selectList(GroupCoin condition, int start,
            int count) {
        return super.selectList(NAMESPACE.concat("select_groupCoin"), start,
            count, condition, GroupCoin.class);
    }
