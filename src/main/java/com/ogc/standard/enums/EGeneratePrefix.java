...
public enum EGeneratePrefix {
    ...
    APPLY_BIND_MAINTAIN("ABM", "申请绑定养护方"), ADOPT_ORDER("AO",
    ...
    Category("C", "产品类型"), Product("P", "认养产品"), ProductSpec("PS",
            "产品规格"), Tree("T", "古树"), Maintainer("M", "养护人"), MaintainProject(
                    "MP", "养护项目"), MaintainRecord("MR", "养护记录"),

    Settle("S", "结算订单"), GiveCarbonBubbleRecord("GCBR",
            "赠送碳泡泡记录"), ShareRecord("SR", "分享记录"),

    TOOL_ORDER("TO", "道具购买订单"),;
