...
import com.ogc.standard.dto.req.XN629457Req;
...
public class XN629457 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return deriveGroupAO.queryDeriveGroupList(condition);
    }

    @Override
    public void doCheck(String inputparams, String operator)
            throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN629457Req.class);
