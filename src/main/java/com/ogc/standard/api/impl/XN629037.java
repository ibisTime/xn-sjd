...
import com.ogc.standard.dto.req.XN629037Req;
 ...
 * @history:
 */
public class XN629037 extends AProcessor {

    private ITreeAO treeAO = SpringContextHolder.getBean(ITreeAO.class);

    private XN629037Req req = null;
    ...
    public Object doBusiness() throws BizException {
        ...
        return treeAO.queryTreeList(condition);
    }

    @Override
    public void doCheck(String inputparams, String operator)
            throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN629037Req.class);
