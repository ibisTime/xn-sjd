...
import com.ogc.standard.dto.req.XN629625Req;
...
public class XN629625 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return maintainProjectAO.queryMaintainProjectPage(start, limit,
            condition);
    }
    ...
    public void doCheck(String inputparams, String operator)
        ...
        req = JsonUtil.json2Bean(inputparams, XN629625Req.class);
