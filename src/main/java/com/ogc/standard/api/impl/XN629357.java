...
import com.ogc.standard.dto.req.XN629357Req;
...
public class XN629357 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return carbonBubbleOrderAO.queryCarbonBubbleOrderList(condition);
    }

    @Override
    public void doCheck(String inputparams, String operator)
            throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN629357Req.class);
