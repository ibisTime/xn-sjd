...
import com.ogc.standard.dto.req.XN629617Req;
...
public class XN629617 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return maintainerAO.queryMaintainerList(condition);
    }

    @Override
    public void doCheck(String inputparams, String operator)
            throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN629617Req.class);
