...
public class WithdrawAOImpl implements IWithdrawAO {
    ...
    //// // // 获取今日散取地址
    //// // EthMAddress mEthAddress =
    //// // tokenAddressBO.getTokenAddress(mAddressCode);
    //// // if (!EAddressType.M.getCode().endsWith(mEthAddress.getType())) {
    //// // throw new BizException(EBizErrorCode.DEFAULT.getCode(),
    //// // "无效的ETH地址，只有散取地址才能进行取现广播！");
    //// // }
    //// // if
    // (EMAddressStatus.IN_USE.getCode().equals(mEthAddress.getStatus()))
    //// // {
    //// // throw new BizException(EBizErrorCode.DEFAULT.getCode(),
    //// // "该散取地址正在广播使用，请稍后再试！");
    //// // }
    ...
    //// // }
    //// // String txHash = TokenClient.transfer(secret,
    ...
    //// // // 获取今日散取地址
    //// // EthMAddress mEthAddress =
    // ethMAddressBO.getEthMAddress(mAddressCode);
    //// // if (!EAddressType.M.getCode().endsWith(mEthAddress.getType())) {
    //// // throw new BizException(EBizErrorCode.DEFAULT.getCode(),
    //// // "无效的ETH地址，只有散取地址才能进行取现广播！");
    //// // }
