...
public class JourAOImpl implements IJourAO {
    ...
    // @Override
    // @Transactional
    // public void checkJour(String code, BigDecimal checkAmount, String
    // checkUser,
    ...
    // doCheckJourHistory(code, checkAmount, checkUser, checkNote, jour);//
    // 历史流水对账
    // }
    // }
    //
    ...
    // hlOrderBO.applyOrder(account, jour, checkAmount, checkUser,
    // checkNote);
    // jourHistoryBO.doCheckJour(jour, EBoolean.NO, checkAmount, checkUser,
    // checkNote);
    // } else {
    ...
    //
    // @Override
    // public Paginable<Jour> queryJourPage(int start, int limit, Jour
    // condition) {
