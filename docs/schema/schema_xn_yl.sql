...
CREATE TABLE `tzb_product` (
  ...
  `collect_first_user` varchar(32) DEFAULT NULL COMMENT '集体第一下单人',
  `location` varchar(32) DEFAULT NULL COMMENT 'UI位置',
...
CREATE TABLE `tsc_commodity` (
  `code` varchar(32) NOT NULL COMMENT '编号',
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `parent_category_code` varchar(32) DEFAULT NULL COMMENT '商品大类',
  `category_code` varchar(32) DEFAULT NULL COMMENT '商品小类',
  ...
  `max_jfdk_rate` DOUBLE DEFAULT NULL COMMENT '最大积分抵扣比例',
  `single_postage_count` INT DEFAULT NULL COMMENT '单邮费数量',
  `location` varchar(32) DEFAULT NULL COMMENT 'UI位置',
  `order_no` int(11) DEFAULT NULL COMMENT 'UI次序',
